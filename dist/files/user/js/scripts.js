(function($) {
  $(function() {
    ...
    var $mainMenu = $(".header__nav__list li span");
    ...
    if(jQuery(window).width() < 768) {
      $('.header__nav__list li.has-submenu').click(function(event){
        $('.header__nav__list li.has-submenu ul').toggleClass('active');
      });
    }
